...
- Mark version-sensitive statements, product claims, and numbers for `fact-checker`.
- Do not invent citations or fake certainty.
- Separate observed opinion from source-backed fact.
